			...
			<div className='col-12 col-md-6 col-lg-4 col-xl-3 mb-5' key={blog._id}>
				<Card className='p-1 m-1' id='cards'>
					<Card>
						...
						<CardImgOverlay>
							<h3>
								<FontAwesomeIcon className='text-danger' icon={faHeart} /> {blog.likes.length}
							</h3>
						</CardImgOverlay>
					</Card>
					...
					<CardBody>
						...
						<div className='row justify-content-center'>
							<Button className='btn btn-sm col-5 mr-1' color='success'>
								<Link
									to={{
							...
							<Button className='col-5 btn btn-sm ml-1' color='danger' onClick={this.showLikes}>
								Likes
							</Button>
						</div>
					</CardBody>
		...
		return (
			<div
				...
				{this.state.blogs ? (
					...
					<div className='btn btn-lg btn-danger'>404 : No Blogs Found</div>
				)}
			</div>
		);
	}
